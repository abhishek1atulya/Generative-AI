...
model = ChatGoogleGenerativeAI(model='gemini-1.5-pro',response_mime_type="application/json")
...
jason_structure = {
    ...
    "required": ["email", "phone", "college", "degree", "major", "skills", "name", "city"]
}
...
structured_model = model.with_structured_output(jason_structure)
